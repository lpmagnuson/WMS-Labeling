...
<div id="banner" class="printhidden">
  <img src="images/logo.png" alt="UL Label Printing" /><p style="clear: none; float: left; font-size: 50px; font-style: italic; margin-bottom: 0px; margin-left: 50px; margin-top: 30px;">&beta;eta</p>
</div>
<div class="clear"></div>
<div id="container">
